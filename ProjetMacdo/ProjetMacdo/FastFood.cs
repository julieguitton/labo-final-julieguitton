...
namespace ProjetMacdo
{
    ...
    public class FastFood
    {
        ...
        {
            listproduit.Clear();
            foreach(Burger burger in CommandeEnCours.Burger)
            {
                listproduit.Add(burger);
            }
            foreach(Boisson boisson in CommandeEnCours.Boisson)
            {
                listproduit.Add(boisson);
            }
            foreach(Accompagnement frite in CommandeEnCours.Accompagnement)
            {
                listproduit.Add(frite);
            }
            foreach(Menu menu in CommandeEnCours.Menu)
            {
                listproduit.Add(menu);
            }
        }
